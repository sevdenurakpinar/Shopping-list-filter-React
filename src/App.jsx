...
const shops = [
  { id: 1, name: 'Migros', location: 'Istanbul', rating: 4.5 },
  { id: 2, name: 'Teknosa', location: 'Ankara', rating: 3.8 },
  { id: 3, name: 'BİM', location: 'Izmir', rating: 4.0 },
  { id: 4, name: 'Carrefour', location: 'Antalya', rating: 4.2 },
  // Ekstra mağazalar ekleyebilirsiniz
];

const categories = [
  { id: 1, name: 'Elektronik', description: 'Elektronik ürünler', parentCategory: null },
  { id: 2, name: 'Gıda', description: 'Temel gıda ürünleri', parentCategory: null },
  { id: 3, name: 'Şarküteri', description: 'Çeşitli şarküteri ürünleri', parentCategory: 2 },
  { id: 4, name: 'Oyuncak', description: 'Çocuk oyuncakları', parentCategory: null },
  { id: 5, name: 'Ev & Yaşam', description: 'Ev eşyaları', parentCategory: null },
